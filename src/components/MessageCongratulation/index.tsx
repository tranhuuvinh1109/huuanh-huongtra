...
const MessageCongratulation = () => {
  ...
  return (
    <div className="mt-24 flex justify-center">
      <div className="m-6 rounded-lg bg-white md:w-1/3">
        <div className="p-6 ">
          <form onSubmit={handleSubmit} method="post">
            ...
            <div>
              <input
                ...
                className="mb-4 w-full rounded-md bg-content-primary px-4 py-2"
                value={data.username}
                name="username"
              ...
              <textarea
                ...
                className="w-full rounded-md bg-content-primary px-4 py-2"
                value={data.message}
                name="message"
                onChange={handleChange}
              />
              <div className="mt-6 flex items-center justify-center">
                <button
                  type="submit"
                  className="rounded-md bg-content px-8 py-2 font-semibold text-grow-custom  hover:bg-pink-300"
                >
                  Gửi lời chúc
                </button>
              </div>
